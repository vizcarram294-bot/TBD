...
export const modules = {
  rrhh: {
    ...
    resources: [
      { key: 'empleados', title: 'Empleados', id: 'id_empleado', fields: [
        ...
        { label: 'Resumen empleado', path: id => `/empleados/${id}/resumen` },
        { label: 'Pagos / Nómina',    path: id => `/empleados/${id}/nomina_pagos` }
      ], quickCreate: { label: 'Registrar asistencia', resource: 'control_asistencia', fields: [text('ci_empleado'[...]
      ...
      { key: 'contrato_empleado', title: 'Contratos de empleado', id: 'id_contrato', fields: [select('id_empleado','Empleado','id_empleado'), select('id_tipo_contrato','Tipo contrato','id_tipo_con[...]
      { key: 'control_asistencia', title: 'Asistencia de trabajadores', id: 'id_asistencia', fields: [text('ci_empleado','CI del empleado', { placeholder: 'Ej: 8564321' }), select('id_empleado','E[...]
      { key: 'asistencia_diaria_resumen', title: 'Resumen diario de asistencia', id: 'id_resumen', fields: [select('id_empleado','Empleado','id_empleado'), date('fecha_resumen','Fecha'), number('m[...]
      { key: 'proyecto_mano_obra', title: 'Mano de obra por proyecto / historial', id: 'id_mano_obra', fields: [], readonly: true, lockMessage: 'Historial automático de mano de obra asignada a pr[...]
      ...
      { key: 'nomina_pagos', title: 'Pagos de empleados / nómina', id: 'id_nomina', noEdit: true, noDelete: true, fields: [select('id_empleado','Empleado','id_empleado'), select('id_periodo_pago'[...]
    ]
  },
  ...
  clientesFinanzas: {
    ...
    resources: [
      ...
      { key: 'cotizaciones', title: 'Cotizaciones', id: 'id_cotizacion', fields: [
        ...
        area('ubicacion_obra','Información de la construcción / ubicación'), number('metros_cuadrados','Metros cuadrados'), number('numero_pisos','Número de pisos'), text('tiempo_estimado','Ti[...]
      ...
      { key: 'plan_pagos', title: 'Plan de pagos', id: 'id_plan_pago', fields: [select('id_proyecto','Proyecto','id_proyecto'), select('id_fase','Fase','id_fase', { dependsOn: 'id_proyecto', disab[...]
      { key: 'liquidaciones', title: 'Liquidaciones', id: 'id_liquidacion', fields: [select('id_proyecto','Proyecto','id_proyecto'), select('id_cotizacion','Cotización','id_cotizacion'), autoDate[...]
    ]
  },
  ...
  proyectos: {
    ...
    resources: [
      ...
      { key: 'flujo_estado_proyecto', title: 'Flujo estado proyecto / historial', id: 'id_flujo', readonly: true, fields: [], lockMessage: 'Registro automático cada vez que cambia el estado del [...]
      { key: 'proyecto_empleado', title: 'Asignar empleados a proyectos', id: 'id_proyecto_empleado', fields: [select('id_proyecto','Proyecto','id_proyecto'), select('id_empleado','Empleado','id_[...]
      { key: 'proyecto_material', title: 'Asignación material a proyecto', id: 'id_proyecto_material', fields: [select('id_proyecto','Proyecto','id_proyecto', { required: true }), select('id_mat[...]
    ]
  },
  inventario: {
    ...
    resources: [
      { key: 'materiales', title: 'Materiales', id: 'id_material', fields: [text('codigo_material','Código material', { disabled: true, help: 'Se genera automáticamente.' }), text('nombre_mater[...]
      ...
      { key: 'orden_pedido', title: 'Órdenes de pedido', id: 'id_orden', fields: [select('id_proveedor','Proveedor','id_proveedor', { required: true }), select('id_material','Material','id_mater[...]
      { key: 'movimiento_inventario', title: 'Movimientos inventario / historial', id: 'id_movimiento', fields: [], readonly: true, lockMessage: 'Se registra automáticamente cuando se asigna mat[...]
      { key: 'costos_material', title: 'Historial costos material', id: 'id_costo_material', fields: [], readonly: true, lockMessage: 'Se registra automáticamente al cambiar el precio de un mate[...]
    ]
  },
  ...
  proveedores: {
    ...
    resources: [
      { key: 'proveedores', title: 'Proveedores', id: 'id_proveedor', fields: [text('nombre_proveedor','Nombre proveedor', { required: true }), text('telefono_proveedor','Teléfono'), area('direc[...]
      { key: 'pagos_proveedor', title: 'Pagos proveedor', id: 'id_pago_proveedor', fields: [select('id_proveedor','Proveedor','id_proveedor', { required: true }), select('id_orden','Orden de pedi[...]
  },
  ...
  subcontratistas: {
    ...
    resources: [
      { key: 'subcontratistas', title: 'Subcontratistas', id: 'id_subcontratista', fields: [
        text('nombre_subcontratista','Nombre subcontratista'), text('representante','Representante'), text('ci_subcontratista','CI'), text('telefono_subcontratista','Teléfono'), text('email_subc[...]
      ...
      { key: 'contrato_subcontratista', title: 'Contratos subcontratistas', id: 'id_contrato_sub', fields: [select('id_subcontratista','Subcontratista','id_subcontratista', { required: true }), s[...]
      { key: 'pago_subcontratista', title: 'Pagos subcontratistas', id: 'id_pago_sub', fields: [select('id_contrato_sub','Contrato','id_contrato_sub', { required: true }), number('monto','Monto p[...]
  },

  catalogos: {
    title: 'Catálogos', subtitle: 'Tablas seleccionables que alimentan los desplegables', icon: 'ti-list-details', owner: 'Compartido',
    resources: [
      { key: 'cargo_empleado', title: 'Cargo empleado', id: 'id_cargo', fields: [text('nombre_cargo','Nombre del cargo', { required: true }), area('descripcion_cargo','Descripción'), number('niv[...]
      { key: 'categoria_empleado', title: 'Categoría empleado', id: 'id_categoria_empleado', fields: [text('nombre_categoria_empleado','Categoría'), area('descripcion_categoria_empleado','Descr[...]
      ...
      { key: 'fases_catalogo', title: 'Fases catálogo', id: 'id_fase_tipo', fields: [text('nombre_fase','Fase'), area('descripcion','Descripción'), staticSelect('estado','Estado',['ACTIVO','INA[...]
      { key: 'categoria_material', title: 'Categoría material', id: 'id_categoria_material', fields: [text('nombre_categoria_material','Categoría material'), area('descripcion_material','Descri[...]
      { key: 'almacen', title: 'Almacenes', id: 'id_almacen', fields: [text('nombre_almacen','Almacén'), area('ubicacion_almacen','Ubicación')] },
      { key: 'categoria_proveedor', title: 'Categoría proveedor', id: 'id_categoria_proveedor', fields: [text('nombre_categoria_proveedor','Categoría proveedor'), area('descripcion_categoria_pr[...]
  ...
  seguridad: {
    ...
    resources: [
      ...
      { key: 'permisos', title: 'Permisos por rol', id: 'id_permiso', fields: [select('id_rol','Rol','id_rol'), text('tabla_objetivo','Tabla o módulo'), staticSelect('operacion','Operación',['S[...]
      { key: 'intentos_login', title: 'Intentos de login / historial', id: 'id_intento', fields: [], readonly: true, lockMessage: 'Registro automático. Más de 3 intentos fallidos bloquean el in[...]
